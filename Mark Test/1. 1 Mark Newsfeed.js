...
lib.ssMetadata = [
		{name:"1. 1 Mark Newsfeed_atlas_1", frames: [[0,895,1383,891],[0,0,1384,893]]},
		{name:"1. 1 Mark Newsfeed_atlas_2", frames: [[0,1724,1438,232],[0,894,980,828],[1440,0,550,512],[1440,514,550,512],[1440,1028,550,512],[0,0,1381,892]]},
		{name:"1. 1 Mark Newsfeed_atlas_3", frames: [[0,0,550,512],[552,0,550,512],[1104,0,550,512],[0,514,550,512],[0,1028,550,512],[552,514,550,512],[1104,514,550,512],[552,1028,550,512],[1104,1028,550,512]]},
		{name:"1. 1 Mark Newsfeed_atlas_4", frames: [[1066,1028,398,232],[1010,1542,552,232],[0,1542,1008,212],[0,0,550,512],[0,514,550,512],[0,1028,550,512],[552,0,550,512],[1564,1700,128,116],[1066,1262,98,116],[1166,1262,98,116],[552,1028,512,512],[1266,1262,76,81],[552,514,550,512],[1564,0,40,1698]]}
];
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["1. 1 Mark Newsfeed_atlas_4"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_12 = function() {
	this.initialize(ss["1. 1 Mark Newsfeed_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._7ef88eb8ecac4f7dbfd7ff93438fee00_13 = function() {
	this.initialize(ss["1. 1 Mark Newsfeed_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Bitmap33 = function() {
	this.initialize(ss["1. 1 Mark Newsfeed_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._11MarkNewsfeed = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_1.png?1591652074322", id:"CachedBmp_1"},
		{src:"images/1. 1 Mark Newsfeed_atlas_1.png?1591652074268", id:"1. 1 Mark Newsfeed_atlas_1"},
		{src:"images/1. 1 Mark Newsfeed_atlas_2.png?1591652074269", id:"1. 1 Mark Newsfeed_atlas_2"},
		{src:"images/1. 1 Mark Newsfeed_atlas_3.png?1591652074269", id:"1. 1 Mark Newsfeed_atlas_3"},
		{src:"images/1. 1 Mark Newsfeed_atlas_4.png?1591652074269", id:"1. 1 Mark Newsfeed_atlas_4"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercom.mp3?1591652074322", id:"MouseClickSoundEffectHDAudioTrimmercom"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercommp3copy.mp3?1591652074322", id:"MouseClickSoundEffectHDAudioTrimmercommp3copy"}
	],
	preloads: []
};
