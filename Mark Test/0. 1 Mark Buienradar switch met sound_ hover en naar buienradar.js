...
(lib._2300 = function(mode,startPosition,loop) {
	...
	// toNext
	this.text = new cjs.Text("To next", "50px 'Calibri'", "#FF0000");
	this.text.textAlign = "center";
	this.text.lineHeight = 63;
	this.text.lineWidth = 283;
	this.text.parent = this;
	this.text.setTransform(406.5,514.15,1,0.9982);
	this.text._off = true;
...
p.nominalBounds = new cjs.Rectangle(0,0,550,640);
...
// stage content:
(lib._01MarkBuienradarswitchmetsoundhoverennaarbuienradar = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
