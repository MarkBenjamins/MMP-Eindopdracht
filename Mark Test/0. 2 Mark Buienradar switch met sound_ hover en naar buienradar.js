...
lib.ssMetadata = [
		{name:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1", frames: [[0,830,1438,232],[1440,0,550,512],[1440,514,550,512],[1440,1028,550,512],[0,1064,550,512],[0,0,980,828],[552,1064,550,512]]},
		{name:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2", frames: [[0,0,550,512],[552,0,550,512],[1104,0,550,512],[0,514,550,512],[0,1028,550,512],[552,514,550,512],[1104,514,550,512],[552,1028,550,512],[1104,1028,550,512]]},
		{name:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3", frames: [[552,234,398,232],[552,0,552,232],[1106,0,40,1698],[0,1542,1008,212],[0,0,550,512],[1010,1700,128,116],[0,514,550,512],[1140,1700,98,116],[0,1756,98,116],[100,1756,76,81],[0,1028,550,512]]}
];
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_12 = function() {
	this.initialize(ss["0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._7ef88eb8ecac4f7dbfd7ff93438fee00_15 = function() {
	this.initialize(ss["0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._02MarkBuienradarswitchmetsoundhoverennaarbuienradar = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.playBuienradar.setTransform(350.5,658.5,1,1,0,0,0,132.5,132.5);
	this.playBuienradar._off = true;
	new cjs.ButtonHelper(this.playBuienradar, 0, 1, 1);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_10.png?1591615727395", id:"CachedBmp_10"},
		{src:"images/CachedBmp_1.png?1591615727395", id:"CachedBmp_1"},
		{src:"images/0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1.png?1591615727346", id:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1"},
		{src:"images/0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2.png?1591615727346", id:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2"},
		{src:"images/0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3.png?1591615727347", id:"0. 2 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercom.mp3?1591615727395", id:"MouseClickSoundEffectHDAudioTrimmercom"}
	],
	preloads: []
};
