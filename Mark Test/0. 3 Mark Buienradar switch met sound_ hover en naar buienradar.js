...
lib.ssMetadata = [
		{name:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1", frames: [[0,830,1438,232],[0,0,980,828],[1440,0,550,512],[1440,514,550,512],[1440,1028,550,512],[0,1064,550,512],[552,1064,550,512]]},
		{name:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2", frames: [[0,0,550,512],[552,0,550,512],[1104,0,550,512],[0,514,550,512],[0,1028,550,512],[552,514,550,512],[1104,514,550,512],[552,1028,550,512],[1104,1028,550,512]]},
		{name:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3", frames: [[1066,0,398,232],[552,514,552,232],[0,1542,1008,212],[1466,0,40,1698],[0,0,550,512],[0,514,550,512],[1066,234,128,116],[1066,352,98,116],[0,1028,550,512],[552,748,98,116],[552,0,512,512],[652,748,76,81]]}
];
...
(lib.CachedBmp_11 = function() {
	this.initialize(ss["0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_12 = function() {
	this.initialize(ss["0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._7ef88eb8ecac4f7dbfd7ff93438fee00_13 = function() {
	this.initialize(ss["0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.PlayBuienradar = function(mode,startPosition,loop) {
	...
	// hover
	this.text = new cjs.Text("Play", "50px 'Calibri'", "#C2E0F0");
	...
	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({_off:false},0).wait(1).to({color:"#000000"},0).wait(1));
...
p.nominalBounds = new cjs.Rectangle(0,0,265,466);
...
// stage content:
(lib._03MarkBuienradarswitchmetsoundhoverennaarbuienradar = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_10.png?1591616967654", id:"CachedBmp_10"},
		{src:"images/CachedBmp_1.png?1591616967654", id:"CachedBmp_1"},
		{src:"images/0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1.png?1591616967597", id:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_1"},
		{src:"images/0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2.png?1591616967597", id:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_2"},
		{src:"images/0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3.png?1591616967598", id:"0. 3 Mark Buienradar switch met sound_ hover en naar buienradar_atlas_3"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercommp3copy.mp3?1591616967654", id:"MouseClickSoundEffectHDAudioTrimmercommp3copy"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercom.mp3?1591616967654", id:"MouseClickSoundEffectHDAudioTrimmercom"}
	],
	preloads: []
};
