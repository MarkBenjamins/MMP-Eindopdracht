...
lib.ssMetadata = [
		{name:"Mark basic template scherm_atlas_1", frames: [[982,0,552,232],[0,1278,398,232],[0,830,1438,232],[1440,234,40,1698],[0,0,980,828],[1536,0,128,116],[1010,1064,98,116],[0,1512,76,81],[982,234,98,116],[0,1064,1008,212]]}
];
...
(lib.CachedBmp_20 = function() {
	this.initialize(ss["Mark basic template scherm_atlas_1"]);
	this.gotoAndStop(0);
...
}).prototype = getMCSymbolPrototype(lib.WeatherBtn, new cjs.Rectangle(0,0,199,116), null);
...
(lib.weerBtn = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer_1
	this.WeatherBtn = new lib.WeatherBtn();
...
}).prototype = getMCSymbolPrototype(lib.weerBtn, new cjs.Rectangle(0,0,199,116), null);
...
(lib.GradenWeer = function(mode,startPosition,loop) {
	...
	// Text
	this.text = new cjs.Text("Go to Weather", "50px 'Calibri'", "#333333");
	this.text.textAlign = "center";
	this.text.lineHeight = 63;
	this.text.lineWidth = 312;
	this.text.parent = this;
	this.text.setTransform(98.05,163.8);
	this.text._off = true;

	this.timeline.addTween(cjs.Tween.get(this.text).wait(1).to({_off:false},0).to({_off:true},1).wait(1));

	// WeatherBtn
	this.weerBtn = new lib.weerBtn();
	this.weerBtn.name = "weerBtn";
	this.weerBtn.setTransform(99.5,58,1,1,0,0,0,99.5,58);

	this.WeatherBtn = new lib.weerBtn();
	this.WeatherBtn.name = "WeatherBtn";
	this.WeatherBtn.setTransform(99.5,58,1,1,0,0,0,99.5,58);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.weerBtn}]}).to({state:[{t:this.weerBtn}]},1).to({state:[{t:this.WeatherBtn}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-60,0,316.2,236.2);


// stage content:
(lib.Markbasictemplatescherm = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.frame_0 = function() {
		...
		*/
		...
		this.WeatherBtn.addEventListener("click", fl_ClickToGoToAndStopAtFrame_3.bind(this));
	...
	this.text.parent = this;
	this.text.setTransform(336,239);

	this.instance = new lib.CachedBmp_18();
	this.instance.setTransform(19,178,0.5,0.5);
	...
	this.timeline.addTween(cjs.Tween.get(this.WeatherBtn).wait(2));
	...
	this.instance_21.setTransform(19,178,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_21},{t:this.text_10}]}).to({state:[]},1).wait(1));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_18.png?1591272545622", id:"CachedBmp_18"},
		{src:"images/Mark basic template scherm_atlas_1.png?1591272545587", id:"Mark basic template scherm_atlas_1"},
		{src:"sounds/MouseClickSoundEffectHD.mp3?1591272545622", id:"MouseClickSoundEffectHD"}
	],
	preloads: []
};
