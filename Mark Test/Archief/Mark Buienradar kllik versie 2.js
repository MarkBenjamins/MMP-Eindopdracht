...
lib.ssMetadata = [
		{name:"Mark Buienradar kllik versie 2_atlas_1", frames: [[0,1278,398,232],[982,0,552,232],[1440,234,40,1698],[0,830,1438,232],[0,0,980,828],[1010,1064,98,116],[1536,0,128,116],[0,1512,76,81],[982,234,98,116],[0,1064,1008,212]]}
];
...
(lib.CachedBmp_19 = function() {
	this.initialize(ss["Mark Buienradar kllik versie 2_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.MarkBuienradarkllikversie2 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_17},{t:this.text_8}]}).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_19},{t:this.instance_18}]}).wait(2));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_20},{t:this.text_9}]}).wait(2));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_18.png?1591274389564", id:"CachedBmp_18"},
		{src:"images/Mark Buienradar kllik versie 2_atlas_1.png?1591274389521", id:"Mark Buienradar kllik versie 2_atlas_1"},
		{src:"sounds/MouseClickSoundEffectHD.mp3?1591274389564", id:"MouseClickSoundEffectHD"}
	],
	preloads: []
};
