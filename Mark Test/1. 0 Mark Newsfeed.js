...
lib.ssMetadata = [
		{name:"1. 0 Mark Newsfeed_atlas_1", frames: [[0,895,1383,891],[0,0,1384,893]]},
		{name:"1. 0 Mark Newsfeed_atlas_2", frames: [[0,1724,1438,232],[0,894,980,828],[1440,0,550,512],[1440,514,550,512],[1440,1028,550,512],[0,0,1381,892]]},
		{name:"1. 0 Mark Newsfeed_atlas_3", frames: [[0,0,550,512],[552,0,550,512],[1104,0,550,512],[0,514,550,512],[0,1028,550,512],[552,514,550,512],[1104,514,550,512],[552,1028,550,512],[1104,1028,550,512]]},
		{name:"1. 0 Mark Newsfeed_atlas_4", frames: [[1010,1542,552,232],[1066,1028,398,232],[1564,0,40,1698],[0,1542,1008,212],[0,0,550,512],[0,514,550,512],[0,1028,550,512],[1564,1700,128,116],[552,0,550,512],[1066,1262,98,116],[1166,1262,98,116],[552,1028,512,512],[1266,1262,76,81],[552,514,550,512]]}
];
...
(lib.CachedBmp_13 = function() {
	this.initialize(ss["1. 0 Mark Newsfeed_atlas_4"]);
	this.gotoAndStop(0);
...
(lib.CachedBmp_12 = function() {
	this.initialize(ss["1. 0 Mark Newsfeed_atlas_2"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib._7ef88eb8ecac4f7dbfd7ff93438fee00_11 = function() {
	this.initialize(ss["1. 0 Mark Newsfeed_atlas_3"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
(lib.Bitmap33 = function() {
	this.initialize(ss["1. 0 Mark Newsfeed_atlas_1"]);
	this.gotoAndStop(0);
}).prototype = p = new cjs.Sprite();
...
// stage content:
(lib._10MarkNewsfeed = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.buttoBuienradar}]},180).to({state:[{t:this.instance}]},13).to({state:[{t:this.instance_1}]},13).to({state:[{t:this.instance_2}]},13).to({state:[{t:this.instance_3}]},13).to({state:[{t:this.instance_4}]},13).to({state:[{t:this.instance_5}]},13).to({state:[{t:this.instance_6}]},13).to({state:[{t:this.instance_7}]},13).to({state:[{t:this.instance_8}]},13).to({state:[{t:this.instance_9}]},13).to({state:[{t:this.instance_10}]},13).to({state:[{t:this.instance_11}]},13).to({state:[{t:this.instance_12}]},13).to({state:[{t:this.instance_13}]},13).to({state:[{t:this.instance_14}]},13).to({state:[{t:this.instance_15}]},13).to({state:[]},13).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[]}).to({state:[{t:this.instance_16},{t:this.text}]},180).to({state:[]},221).wait(222));

	// UserIcon
	this.instance_17 = new lib.Bitmap17();
	this.instance_17.setTransform(1381,32);

	this.timeline.addTween(cjs.Tween.get(this.instance_17).to({_off:true},401).wait(222));

	// KleurAanwezigheid
	this.instance_18 = new lib.CachedBmp_2();
	this.instance_18.setTransform(1390,187.5,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance_18).to({_off:true},401).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_33},{t:this.text_8}]}).to({state:[]},401).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_35},{t:this.instance_34}]}).to({state:[]},401).wait(222));
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_36},{t:this.text_9}]}).to({state:[]},401).wait(222));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_10.png?1591647622077", id:"CachedBmp_10"},
		{src:"images/1. 0 Mark Newsfeed_atlas_1.png?1591647622018", id:"1. 0 Mark Newsfeed_atlas_1"},
		{src:"images/1. 0 Mark Newsfeed_atlas_2.png?1591647622018", id:"1. 0 Mark Newsfeed_atlas_2"},
		{src:"images/1. 0 Mark Newsfeed_atlas_3.png?1591647622019", id:"1. 0 Mark Newsfeed_atlas_3"},
		{src:"images/1. 0 Mark Newsfeed_atlas_4.png?1591647622019", id:"1. 0 Mark Newsfeed_atlas_4"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercommp3copy.mp3?1591647622077", id:"MouseClickSoundEffectHDAudioTrimmercommp3copy"},
		{src:"sounds/MouseClickSoundEffectHDAudioTrimmercom.mp3?1591647622078", id:"MouseClickSoundEffectHDAudioTrimmercom"}
	],
	preloads: []
};
